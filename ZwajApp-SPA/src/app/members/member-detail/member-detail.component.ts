...
export class MemberDetailComponent implements OnInit {
  ...
  constructor(private userservic: UserService, private alertify: AlertifyService, private route: ActivatedRoute) { }
  ...
  /*loadUser()
  {
    this.userservic.GetUser(+this.route.snapshot.params['id']).subscribe((user:User)=>{
      this.user=user
    },
